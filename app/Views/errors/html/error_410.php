...
<head>
    ...
    <title>Contenido Eliminado (410) | APIEmpresas</title>
...
<body>
    ...
    <div class="container">
        <div class="error-card">
            <h1 class="headline">410</h1>
            <p class="lead">Contenido Eliminado Permanentemente</p>
            <p>
                <?php if (isset($message) && $message !== '404 - File Not Found') : ?>
                    <?= nl2br(esc($message)) ?>
                <?php else : ?>
                    El perfil que buscas ha sido eliminado permanentemente de nuestros registros debido a una solicitud de privacidad (RGPD) o porque la información ya no está disponible.
                <?php endif; ?>
