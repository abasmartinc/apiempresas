...
<body>
    ...
    <main class="radar-page">
        ...
        <section class="radar-hero">
            <div class="container">
                <div class="radar-hero__shell">
                    ...
                    <h1 class="radar-hero__title" style="font-size: clamp(2rem, 5vw, 3.5rem); line-height: 1.1; margin-bottom: 1.5rem;">
                    ...
                    <p style="font-size: 1.25rem; font-weight: 700; color: #1e293b; margin-bottom: 1rem;">
                        Convierte tu web en una herramienta que aporta valor real a tus usuarios y aumenta el engagement o las oportunidades de negocio sin desarrollar nada.
                    </p>

                    <p class="radar-hero__subtitle" style="font-size: 1.1rem; color: #475569; max-width: 800px; margin-left: auto; margin-right: auto; line-height: 1.6;">
                        Empieza hoy y convierte tu web en una herramienta que genera valor real para tus usuarios desde el primer minuto.
                    </p>

                    <div class="radar-hero__proof" style="margin-top: 2.5rem; display: flex; justify-content: center; gap: 40px;">
                    ...
                    <div class="radar-hero__actions" style="margin-top: 2.5rem; display: flex; flex-direction: column; align-items: center; gap: 16px;">
                        <a href="<?= site_url('obtener-plugin-wordpress') ?>" class="radar-btn radar-btn--primary js-track-wp-cta" style="padding: 18px 40px; font-weight: 800;">
                            Instalar plugin y empezar ahora
                        </a>
                        <div style="display: flex; flex-direction: column; gap: 4px;">
                            <p style="font-size: 0.85rem; color: #2563eb; font-weight: 800; margin: 0;">Activa datos reales en tu web en menos de 60 segundos</p>
                            <p style="font-size: 0.8rem; color: #94a3b8; font-weight: 500; margin: 0;">Usado por agencias, SaaS y directorios para generar valor en sus webs</p>
                        </div>
                    </div>

                <!-- BLOQUE SIN FRICCIÓN -->
                <div style="margin-top: 40px; text-align: center;">
                    <div style="display: inline-flex; gap: 32px; padding: 16px 32px; background: #fff; border-radius: 16px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
                        <span style="font-size: 0.95rem; font-weight: 800; color: #0f172a; display: flex; align-items: center; gap: 8px;"><span style="color: #2563eb;">✔</span> Sin backend</span>
                        <span style="font-size: 0.95rem; font-weight: 800; color: #0f172a; display: flex; align-items: center; gap: 8px;"><span style="color: #2563eb;">✔</span> Sin configuración compleja</span>
                        <span style="font-size: 0.95rem; font-weight: 800; color: #0f172a; display: flex; align-items: center; gap: 8px;"><span style="color: #2563eb;">✔</span> Sin mantenimiento</span>
                    </div>
                </div>

                <!-- BLOQUE VALOR INMEDIATO -->
                <div style="margin-top: 40px; text-align: center;">
                    <div style="display: inline-flex; gap: 24px; padding: 12px 24px; background: #f0f7ff; border-radius: 99px; border: 1px solid #dbeafe;">
                        <span style="font-size: 0.9rem; font-weight: 700; color: #1e40af;">Qué consigues al instalarlo:</span>
                ...
                <!-- BLOQUE CASOS DE USO -->
                <div style="margin-top: 60px; padding: 40px; background: #fff; border-radius: 24px; border: 1px solid #e2e8f0; text-align: left; box-shadow: 0 20px 40px -10px rgba(0,0,0,0.05);">
                    <p style="color: #2563eb; font-size: 0.75rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 30px; text-align: center;">Cómo lo usan nuestros clientes</p>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 30px;">
                        <div style="display: flex; align-items: flex-start; gap: 16px;">
                            <div style="font-size: 2rem;">📁</div>
                            <div>
                                <div style="font-size: 1rem; font-weight: 800; color: #0f172a; margin-bottom: 4px;">Directorios</div>
                                <div style="font-size: 0.85rem; color: #64748b; line-height: 1.4;">Aumentan el tiempo en página y la retención automáticamente.</div>
                            </div>
                        </div>
                        <div style="display: flex; align-items: flex-start; gap: 16px;">
                            <div style="font-size: 2rem;">🎯</div>
                            <div>
                                <div style="font-size: 1rem; font-weight: 800; color: #0f172a; margin-bottom: 4px;">Agencias</div>
                                <div style="font-size: 0.85rem; color: #64748b; line-height: 1.4;">Generan leads cualificados de forma totalmente pasiva.</div>
                            </div>
                        </div>
                        <div style="display: flex; align-items: flex-start; gap: 16px;">
                            <div style="font-size: 2rem;">⚡</div>
                            <div>
                                <div style="font-size: 1rem; font-weight: 800; color: #0f172a; margin-bottom: 4px;">SaaS</div>
                                <div style="font-size: 0.85rem; color: #64748b; line-height: 1.4;">Integran datos sin backend y escalan su producto rápido.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="radar-hero__feature-panel" style="max-width: 1040px; margin-top: 60px;">
                        <div class="radar-hero__feature-copy">
                            <h2 style="font-size: 2rem; font-weight: 850; letter-spacing: -0.02em;">El buscador oficial ahora en tu CMS favorito</h2>
            ...
            <div class="container">
                ...
                <div class="radar-grid"
                    ...
                    <div class="api-feature-card" style="padding: 24px;">
                        ...
                        <p class="radar-text" style="font-size: 0.9rem;">Ofrece información valiosa del Registro Mercantil que tus usuarios realmente necesitan consultar.</p>
                    </div>
                    <div class="api-feature-card" style="padding: 24px;">
                        <div class="api-feature-icon" style="margin-bottom: 15px;">✔</div>
                        <h3 style="font-size: 1.1rem; margin-bottom: 10px;">Aumenta engagement</h3>
                        <p class="radar-text" style="font-size: 0.9rem;">Mantén a tus visitantes más tiempo en tu sitio proporcionándoles las herramientas que buscan.</p>
                    </div>
                    <div class="api-feature-card" style="padding: 24px;">
                        <div class="api-feature-icon" style="margin-bottom: 15px;">✔</div>
                        <h3 style="font-size: 1.1rem; margin-bottom: 10px;">Integra datos oficiales</h3>
                        <p class="radar-text" style="font-size: 0.9rem;">Olvídate de APIs complejas. Instalación no-code lista para funcionar en menos de 60s.</p>
                    </div>
                    <div class="api-feature-card" style="padding: 24px;">
                        <div class="api-feature-icon" style="margin-bottom: 15px;">✔</div>
                        <h3 style="font-size: 1.1rem; margin-bottom: 10px;">Escala con tu plan</h3>
                        <p class="radar-text" style="font-size: 0.9rem;">A medida que tu negocio crezca, el plugin se adapta a tus nuevas necesidades sin cambios.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="api-pricing-grid">
                    ...
                    <div class="api-pricing-card featured">
                        ...
                        <p class="api-pricing-card__desc">Para webs que quieren crecer y monetizar su tráfico. Más consultas → más valor.</p>
                ...
                <div style="margin-top: 80px; position: relative;">
                    <div style="background: linear-gradient(180deg, #ffffff 0%, #f8fafc 100%); padding: 48px; border-radius: 32px; border: 1px solid #e2e8f0; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.05), 0 10px 10px -5px rgba(0, 0, 0, 0.02); text-align: center;">
                        <div style="display: inline-block; background: #f0f7ff; color: #2563eb; font-size: 0.8rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.1em; padding: 6px 16px; border-radius: 99px; margin-bottom: 24px;">
                            Ecosistema de Crecimiento
                        </div>
                        <h3 style="font-size: 1.5rem; font-weight: 850; color: #0f172a; margin-bottom: 16px; letter-spacing: -0.02em;">A medida que crece tu web, desbloquea:</h3>
                        
                        <div style="display: flex; justify-content: center; gap: 24px; flex-wrap: wrap; margin-top: 32px;">
                            <!-- Benefit 1 -->
                            <div style="background: #fff; border: 1px solid #f1f5f9; padding: 12px 24px; border-radius: 16px; display: flex; align-items: center; gap: 12px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.03);">
                                <div style="width: 32px; height: 32px; background: #eff6ff; border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4a2 2 0 0 0 1-1.73z"></path></svg>
                                </div>
                            ...
                            <div style="background: #fff; border: 1px solid #f1f5f9; padding: 12px 24px; border-radius: 16px; display: flex; align-items: center; gap: 12px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.03);">
                                <div style="width: 32px; height: 32px; background: #fef2f2; border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ef4444" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"></polyline><polyline points="16 7 22 7 22 13"></polyline></svg>
                                </div>
                            ...
                            <div style="background: #fff; border: 1px solid #f1f5f9; padding: 12px 24px; border-radius: 16px; display: flex; align-items: center; gap: 12px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.03);">
                                <div style="width: 32px; height: 32px; background: #ecfdf5; border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>
                                </div>
                                <span style="font-weight: 700; color: #475569; font-size: 1rem;">Scoring de empresas</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="radar-section">
            <div class="container">
                <div style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); border-radius: 32px; padding: 60px; color: #fff; text-align: center; position: relative; overflow: hidden;">
                    <div style="position: absolute; top: -20%; right: -10%; width: 40%; height: 60%; background: radial-gradient(circle, rgba(59, 130, 246, 0.2) 0%, transparent 70%); filter: blur(40px);"></div>
                    <div style="position: relative; z-index: 2;">
                        <h2 style="font-size: 2.2rem; font-weight: 850; margin-bottom: 16px;">Estas empresas están buscando proveedor ahora mismo</h2>
                        <p style="font-size: 1.2rem; color: #94a3b8; max-width: 650px; margin: 0 auto 12px; line-height: 1.6;">
                            Cada día nuevas empresas aparecen — si no contactas tú, otro proveedor lo hará primero.
                        </p>
                        <p style="font-size: 0.85rem; color: #60a5fa; font-weight: 700; margin-bottom: 32px;">Actualizado en tiempo real con datos del BORME</p>
                        <a href="<?= site_url('radar/preview') ?>" class="radar-btn radar-btn--primary" style="padding: 16px 40px; font-size: 1.1rem;">Ver empresas activas ahora</a>
                    </div>
                </div>
            </div>
        </section>
...
        ...
        <section class="radar-section radar-section--soft">
            <div class="container">
                <div style="background: #fff; border: 1px solid #e2e8f0; border-radius: 32px; padding: 40px; display: flex; align-items: center; justify-content: space-between; gap: 40px; flex-wrap: wrap;">
                    <div style="flex: 1; min-width: 300px;">
                        <h2 style="font-size: 1.8rem; font-weight: 850; color: #0f172a; margin-bottom: 12px;">¿Necesitas más?</h2>
                        <p style="font-size: 1.1rem; color: #64748b; margin: 0;">Activa un plan y desbloquea más consultas, datos avanzados y funcionalidades adicionales.</p>
                    </div>
                    <a href="<?= site_url('api-empresas') ?>" class="radar-btn radar-btn--primary" style="padding: 16px 32px;">Ver planes y precios</a>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div
                    ...
                    <div style="position: relative; z-index: 10;">
                        <h2 style="color: #ffffff; font-size: clamp(1.8rem, 5vw, 2.5rem); font-weight: 950; margin: 0 0 20px; letter-spacing: -0.04em; line-height: 1.1;">
                        ...
                        <div style="display: flex; flex-direction: column; align-items: center; gap: 24px;">
                            ...
                            <div style="display: flex; gap: 24px; flex-wrap: wrap; justify-content: center;">
                                <span style="color: #fff; font-size: 0.95rem; font-weight: 700; display: flex; align-items: center; gap: 8px;">
    ...
    <div id="wp-coming-soon-modal" style="display: none; position: fixed; inset: 0; z-index: 9999; align-items: center; justify-content: center; padding: 20px;">
        <!-- Backdrop -->
        <div style="position: absolute; inset: 0; background: rgba(15, 23, 42, 0.8); backdrop-filter: blur(8px);"></div>
        
        <!-- Modal Card -->
        <div style="position: relative; background: #fff; width: 100%; max-width: 500px; border-radius: 32px; padding: 48px 40px; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25); text-align: center; overflow: hidden;">
            <!-- Decoration -->
            <div style="position: absolute; top: -50px; right: -50px; width: 150px; height: 150px; background: radial-gradient(circle, rgba(37, 99, 235, 0.1) 0%, transparent 70%);"></div>
            
            <div style="width: 80px; height: 80px; background: #f0f7ff; border-radius: 24px; display: flex; align-items: center; justify-content: center; margin: 0 auto 24px;">
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#2563eb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
            </div>

            <h3 style="font-size: 1.75rem; font-weight: 850; color: #0f172a; margin-bottom: 16px; letter-spacing: -0.02em;">¡Estamos casi listos!</h3>
            
            <p style="font-size: 1.1rem; color: #475569; line-height: 1.6; margin-bottom: 32px;">
                Estamos ultimando los detalles para que tu experiencia con el plugin de <strong>APIEmpresas</strong> sea perfecta. Estará disponible para descarga en los próximos días.
            </p>
