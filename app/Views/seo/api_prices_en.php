...
<head>
    <?= view('partials/head', [
        ...
        'canonical'   => site_url('spanish-company-api'),
        'robots'      => 'index,follow',
        'hreflang_es' => site_url('api-empresas'),
        'hreflang_en' => site_url('spanish-company-api'),
    ]) ?>
    <link rel="stylesheet"
        ...
        <header class="api-unified-hero">
            <div class="container" style="max-width:1100px; margin:0 auto; padding:0 2rem;">
                ...
                <div class="lang-switcher">
                    <a href="<?= site_url('api-empresas') ?>" class="inactive" title="Versión en español">🇪🇸 ES</a>
                    <a href="<?= site_url('spanish-company-api') ?>" class="active" title="English version">🇬🇧 EN</a>
                </div>
