...
<section id="leads-b2b-recientes" class="ae-radar-page__section ae-radar-page__section--leads container">
    ...
    <div class="ae-radar-page__paywall-zone">
        <div class="ae-radar-page__paywall-grid" aria-hidden="true" style="opacity: 0.4;">
...
<section class="ae-radar-page__section container" style="background: transparent !important; border: none !important; box-shadow: none !important; padding: 0 !important; margin-top: 3rem !important;">
    ...
    function showRadarModal(trigger = 'unknown') {
        ...
        if (modal) {
            ...
            if (window.trackEvent) {
                window.trackEvent('radar_modal_view', { trigger: trigger, page: 'radar_period_landing' });
            }
        }
    }
    ...
    function closeRadarModal() {
        ...
        if (modal) {
            ...
            if (window.trackEvent) {
                window.trackEvent('radar_modal_close', { page: 'radar_period_landing' });
            }
        }
    }
