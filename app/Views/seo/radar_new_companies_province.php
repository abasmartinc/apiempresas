...
<section id="leads-b2b-recientes" class="ae-radar-page__section ae-radar-page__section--leads container">
            ...
            <div style="padding-bottom: 1.75rem; position: relative;">
                ...
                <h2 style="font-size: 2rem; font-weight: 900; color: #0f172a; margin: 0 0 0.6rem; letter-spacing: -0.025em; line-height: 1.15;">
                        ...
                        Empresas recién creadas en <span style="background: linear-gradient(135deg, #3b82f6, #10b981); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;"><?= esc(ucfirst(mb_strtolower($province))) ?></span>
                                ...
                                <div class="ae-radar-page__paywall-body">
                                    <div class="ae-radar-page__paywall-header">
                                        ...
                                        <p class="ae-radar-page__paywall-subtitle">
                                            Accede al directorio completo de nuevas empresas en <?= esc($province) ?> y detecta oportunidades filtrables por sector y fecha de constitución.
                                        </p>
                                    </div>
        ...
        <section class="ae-radar-page__section ae-radar-page__section--excel container" style="background: linear-gradient(135deg, #122347 0%, #19366d 55%, #2d57c7 100%) !important; border-radius: 2rem !important; overflow: hidden !important; border: 1px solid rgba(255,255,255,0.1) !important; box-shadow: 0 24px 60px -30px rgba(15, 23, 42, 0.34) !important;">
                ...
                <div class="ae-radar-page__excel-content">
                    ...
                    <p class="ae-radar-page__excel-subtitle">
                        Descarga el directorio completo de nuevas empresas en <?= esc($province) ?> en formato XLSX, listo para identificar oportunidades comerciales.
                    </p>
                    ...
                    <div class="ae-radar-page__excel-actions">
                        <div style="display: flex; flex-direction: column; gap: 8px; width: 100%; max-width: 700px;">
                            <a href="<?= site_url('excel/preview?provincia=' . urlencode($province ?? '') . '&sector=' . urlencode($sectorLabel ?? '') . '&period=' . urlencode(empty($period) || $period === 'general' ? '30days' : $period)) ?>" class="ae-radar-page__excel-btn js-loading-btn" style="white-space: nowrap !important;">
                                Acceder al listado de <?= esc($province) ?> (<?= number_format($total_context_count ?? 0, 0, ',', '.') ?> empresas) · <?php if(isset($dynamic_price['is_discounted']) && $dynamic_price['is_discounted']): ?><s style="opacity:0.65; font-size:0.85em; margin-right:4px;"><?= number_format($dynamic_price['original_price'], 0) ?>€</s><?php endif; ?><?= number_format($dynamic_price['base_price'] ?? 9, 0) ?>€ <span style="font-size:0.85em; opacity:0.85; font-weight:600;">+ IVA</span>
                            </a>
                        </div>
        ...
        <script type="application/ld+json">
        {
          ...
          "@graph": [
            ...
            },
            {
              ...
              "description": "Acceso directo al listado de nuevas empresas en <?= esc($province) ?> en formato Excel para detectar oportunidades comerciales.",
              "offers": {
                "@type": "Offer",
