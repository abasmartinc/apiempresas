            ...
            <div class="ae-radar-page__hero-inner">
                ...
                <nav class="ae-radar-page__breadcrumbs" aria-label="Breadcrumb">
                    <ol class="ae-radar-page__breadcrumbs-list">
                        ...
                        <li class="ae-radar-page__breadcrumbs-separator">/</li>
                        <li class="ae-radar-page__breadcrumbs-current" aria-current="page"><?= esc($province) ?></li>
                    </ol>
                </nav>
                ...
                <p class="ae-radar-page__hero-copy">
                    En <?= esc(ucfirst(mb_strtolower($province))) ?> se registran nuevas empresas cada día con necesidades tempranas de servicios B2B. Esta página te ayuda a detectar esas oportunidades y contactar con los fundadores desde el primer día.
                </p>
                ...
                <div class="ae-radar-page__hero-actions">
                    ...
                    <?php if (!($is_low_results ?? false)): ?>
                        ...
                        <div style="display: flex; flex-direction: column; gap: 8px;">
                            <a href="<?= $buildCheckoutUrl ?>" class="ae-radar-page__btn ae-radar-page__btn--soft js-loading-btn">
                    ...
                    <div class="ae-radar-page__hero-alt-downloads">
                        ...
                        <?php if (($national_stats['hoy'] ?? 0) > 0): ?>
                            <a href="<?= site_url('checkout/radar-export?period=hoy') ?>" class="js-loading-btn">Nacional Hoy (<?= number_format($national_stats['hoy'] ?? 0, 0, ',', '.') ?> empresas) · <?= number_format($national_prices['hoy'] ?? 2, 0) ?>€</a>
                        <?php endif; ?>
                        <?php if (($national_stats['semana'] ?? 0) > 0): ?>
                            <a href="<?= site_url('checkout/radar-export?period=semana') ?>" class="js-loading-btn">Nacional Semana (<?= number_format($national_stats['semana'] ?? 0, 0, ',', '.') ?> empresas) · <?= number_format($national_prices['semana'] ?? 4, 0) ?>€</a>
                        <?php endif; ?>
                        <?php if (($national_stats['30days'] ?? 0) > 0): ?>
                            <a href="<?= site_url('checkout/radar-export?period=30days') ?>" class="js-loading-btn">Nacional Mes (<?= number_format($national_stats['30days'] ?? 0, 0, ',', '.') ?> empresas) · <?= number_format($national_prices['mes'] ?? 9, 0) ?>€</a>
                        <?php endif; ?>
                    </div>
                ...
                <div class="ae-radar-page__hero-panel">
                    <div class="ae-radar-page__hero-panel-copy">
                        ...
                        <ul class="ae-radar-page__hero-list">
                            <li>Monitoriza constituciones en <?= esc(ucfirst(mb_strtolower($province))) ?></li>
                            ...
                            <div class="ae-radar-page__premium-strip-wrap">
                                <div class="ae-radar-page__premium-strip">
                                    <div class="ae-radar-page__premium-strip-copy">
                                        <h3>Desbloquea el listado completo en <?= esc($province) ?></h3>
                                        <p>
                                            Accede a todas las sociedades detectadas en este periodo en <?= esc($province) ?>, filtra por sector y exporta leads preparados para prospección comercial.
                                        </p>

                                        <div class="ae-radar-page__premium-points">
                                            <span>Filtros sectoriales avanzados</span>
                            ...
                            <div class="ae-radar-page__paywall-card">
                                ...
                                <div class="ae-radar-page__paywall-body">
                                    <div class="ae-radar-page__paywall-header">
                                        ...
                                        <div class="ae-radar-page__paywall-kicker">Acceso Premium Local</div>

                                        <h3 class="ae-radar-page__paywall-title">
                                            Listado completo de empresas en <?= esc($province) ?>
                                        </h3>

                                        <p class="ae-radar-page__paywall-subtitle">
                                            Accede al directorio completo de nuevas empresas en <?= esc($province) ?> y trabaja con leads filtrables por sector y fecha de constitución.
                                        </p>
                                    </div>
                                    ...
                                    <div class="ae-radar-page__paywall-actions">
                                        ...
                                        <a href="<?= $buildCheckoutUrl ?>" class="ae-radar-page__paywall-btn ae-radar-page__paywall-btn--secondary js-loading-btn">
                                            <span>Descargar Listado Provincial</span>
        ...
        <section class="ae-radar-page__section ae-radar-page__section--excel container">
            <div class="ae-radar-page__excel-box">
                <div class="ae-radar-page__excel-content">
                    ...
                    <h3 class="ae-radar-page__excel-title">¿Necesitas el listado de <?= esc($province) ?> en Excel?</h3>

                    <p class="ae-radar-page__excel-subtitle">
                        Descarga el directorio completo de nuevas empresas en <?= esc($province) ?> en formato XLSX, listo para prospección comercial.
                    </p>

                    <div class="ae-radar-page__excel-actions">
                        <div style="display: flex; flex-direction: column; gap: 8px; width: 100%; max-width: 400px;">
                            <a href="<?= site_url('checkout/radar-export?provincia=' . urlencode($province ?? '') . '&sector=' . urlencode($sectorLabel) . '&period=' . urlencode(empty($period) || $period === 'general' ? '30days' : $period)) ?>" class="ae-radar-page__excel-btn js-loading-btn">
                                Descargar listado (<?= number_format($total_context_count ?? 0, 0, ',', '.') ?> empresas) · <?= number_format($dynamic_price['base_price'] ?? 9, 0) ?>€
                            </a>
                        </div>
        ...
        <section class="ae-radar-page__section ae-radar-page__section--seo container">
            <div class="ae-radar-page__seo-box">
                <div class="ae-radar-page__section-head ae-radar-page__section-head--left">
                    ...
                    <h2 class="ae-radar-page__section-title ae-radar-page__section-title--left">
                        Sobre las nuevas empresas en <?= esc($province) ?>
                    </h2>
                </div>
                ...
                <div class="ae-radar-page__seo-content">
                    ...
                    <p>
                        Con el Radar puedes detectar estas nuevas empresas antes que tu competencia y posicionarte como su proveedor desde el primer día en <?= esc($province) ?>.
                    </p>
                </div>
            </div>
        </section>
        ...
        <script type="application/ld+json">
        {
          ...
          "@graph": [
            ...
            },
            {
              ...
              "description": "Descarga directa del listado B2B de nuevas empresas en <?= esc($province) ?> en formato Excel para prospección comercial.",
              "offers": {
                "@type": "Offer",
