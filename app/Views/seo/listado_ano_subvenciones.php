                        ...
                        <table class="prem-table">
                            ...
                            <?php else: ?>
                                ...
                                <tr<?= $hasCompany ? ' onclick="window.location=\'' . esc($cUrl) . '\'"' : ' style="cursor: default;"' ?>>
                                    <td>
                                        <?php if ($hasCompany): ?>
                                            <a href="<?= esc($cUrl) ?>" style="color: #0f172a; font-weight: 700; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#10b981'" onmouseout="this.style.color='#0f172a'"><?= esc($sub['company_name']) ?></a>
                                        <?php else: ?>
