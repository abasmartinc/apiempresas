    ...
    <main class="dir-main">
        <div class="container">
            <div class="dir-main-card">
                ...
                <form method="GET" action="<?= site_url('licitaciones-del-estado/ano-' . $year) ?>" style="margin-bottom: 24px; position: relative;">
                ...
                <div style="margin-bottom: 32px; padding: 16px 24px; background: #eff6ff; border-radius: 14px; border: 1px solid #bfdbfe; display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <a href="<?= site_url('licitaciones-del-estado/ano-' . $year) ?>" style="color: #64748b; text-decoration: none; font-size: 0.85rem; font-weight: 600; display: flex; align-items: center; gap: 4px;">
                ...
                <section class="dir-section">
                    <div class="section-header">
                        ...
                        <h2>Contratos Adjudicados</h2>
                        <span class="section-header__count"><?= number_format($total, 0, ',', '.') ?> contratos</span>
                        <div class="line"></div>
                    </div>
                    ...
                    <div class="prem-table-wrap">
                        <table class="prem-table">
                            ...
                            <?php if (empty($contracts)): ?>
                                <tr><td colspan="5" style="text-align: center; color: #64748b; padding: 48px; font-weight: 500;">No hay contratos registrados para <?= $year ?>.</td></tr>
                            <?php else: ?>
                                ...
                                <tr onclick="window.location='<?= esc($cUrl) ?>'">
                                    ...
                                    <td style="color: #475569; font-size: 0.9rem; max-width: 300px;">
                                        <div style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;"><?= esc($contract['titulo_contrato']) ?></div>
                                    </td>
                                    <td style="color: #64748b; font-size: 0.85rem; max-width: 220px;">
                                        <div style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;"><?= esc(mb_convert_case($contract['organo_contratacion'], MB_CASE_TITLE, 'UTF-8')) ?></div>
                                    </td>
                                    <td style="white-space: nowrap; color: #64748b; font-size: 0.9rem;"><?= date('d/m/Y', strtotime($contract['fecha_adjudicacion'])) ?></td>
                                    <td style="text-align: right;">
                                        <span class="amount-badge"><?= number_format($contract['importe_adjudicacion'], 2, ',', '.') ?> €</span>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
                ...
                <section style="margin-top: 48px; padding-top: 40px; border-top: 1px solid #e2e8f0;">
                    ...
                    <div style="display: grid; gap: 24px;">
                        ...
                        <div>
                            ...
                            <p style="color: #475569; font-size: 0.9rem; line-height: 1.6; margin: 0;">Haz clic sobre el nombre de cualquier empresa en el listado para acceder a su ficha mercantil completa, donde encontrarás su historial de contratos y subvenciones públicas, datos de contacto, información CNAE, y más.</p>
                        </div>
                    </div>
                </section>
                <!-- /SEO Content -->
