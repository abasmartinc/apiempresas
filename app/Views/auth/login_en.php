    ...
    <div class="auth-form-side">
        <div class="auth-form-container">
            ...
            <form class="auth-form" method="post" action="/login">
                ...
                <button type="submit" class="auth-btn-primary" id="login-submit">Enter Dashboard</button>
                ...
                <div class="social-login-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; margin-top: 16px;">
                    <a href="/auth/google" class="social-btn google" style="display: flex; align-items: center; justify-content: center; gap: 6px; background: #ffffff; color: #1e293b; border: 1px solid #e2e8f0; border-radius: 12px; padding: 10px 5px; font-size: 13px; font-weight: 700; text-decoration: none; transition: all 0.25s ease;">
                        <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="Google" width="16">
                        <span>Google</span>
                    </a>
                    <a href="/auth/github" class="social-btn github" style="display: flex; align-items: center; justify-content: center; gap: 6px; border-radius: 12px; padding: 10px 5px; font-size: 13px; font-weight: 700; text-decoration: none; transition: all 0.25s ease;">
                    ...
                    <a href="/auth/linkedin" class="social-btn linkedin" style="display: flex; align-items: center; justify-content: center; gap: 6px; border-radius: 12px; padding: 10px 5px; font-size: 13px; font-weight: 700; text-decoration: none; transition: all 0.25s ease;">
            ...
            <div class="auth-form-footer">
                Don't have a professional account? <a href="/register">Start now</a>
            </div>
        </div>

        <div class="auth-legal-footer">
            © <?= date('Y') ?> SpainCompanyAPI. <a href="#" data-modal-target="modalTerms">Legal Notice</a> · <a href="#" data-modal-target="modalPrivacy">Privacy</a>
        </div>
    </div>
</div>
