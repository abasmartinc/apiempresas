<div class="auth-branding">
    <div class="auth-logo-row">
        <a href="<?= site_url() ?>" class="auth-logo-link" style="display: flex; align-items: center; gap: 12px; text-decoration: none; color: inherit;">
            ...
            <span class="auth-logo-text">SpainCompanyAPI</span>
        </a>
    </div>

    <div class="auth-branding-main">
        <h1 class="auth-branding-title">The Commercial Intelligence API <span>built to scale</span></h1>
        <p class="auth-branding-sub">Automate customer onboarding, reduce financial risks and enrich your CRM by integrating official data of <strong style="background: linear-gradient(135deg, #ffe162 0%, #ff6b00 100%); -webkit-background-clip: text; background-clip: text; -webkit-text-fill-color: transparent; font-weight: 900;">more than 4 million Spanish companies</strong> into your software.</p>
        ...
        <div class="auth-features">
            <div class="auth-feature-item">
                ...
                <div class="auth-feature-content">
                    <h4>Company API</h4>
                    <p>Integrate CIF validation, official data and scoring in minutes with a powerful and secure infrastructure.</p>
                </div>
            </div>
            ...
            <div class="auth-feature-item">
                ...
                <div class="auth-feature-content">
                    <h4>Company Radar</h4>
                    <p>Detect new companies, prioritize opportunities and accelerate your B2B prospecting before your competition.</p>
                </div>
            </div>
            ...
            <div class="auth-feature-item">
                ...
                <div class="auth-feature-content">
                    <h4>Bank-Grade Data</h4>
                    <p>100% official information synchronized with the BORME, ideal for validation (KYC/KYB) and B2B analysis.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="auth-branding-footer">
        <div class="auth-social-badge">
            ...
            Used by +500 advisors and Spanish companies
        </div>
    </div>
</div>
