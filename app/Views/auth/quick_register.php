    ...
    <main class="container">
        <div class="register-container">
            ...
            <?php elseif (($intent ?? '') === 'view_risk_profile'): ?>
                ...
                <!-- Google: quien tiene cuenta de Google entra en un clic y vuelve al mismo
                     destino (el dictamen o el pago). Faltaba en esta pantalla, aunque el
                     teaser de la ficha sí lo ofrecía. -->
                <a href="<?= esc(site_url('auth/google') . '?' . http_build_query(array_filter([
                        'intent'   => 'view_risk_profile',
                        'cif'      => $signupCif ?? '',
                        'redirect' => $redirect ?? '',
                    ])), 'attr') ?>"
                   data-track-click="quick_register_google"
                   style="display: flex; align-items: center; justify-content: center; gap: 10px; width: 100%; box-sizing: border-box; padding: 13px 18px; border-radius: 12px; border: 1.5px solid #cbd5e1; background: #fff; color: #1e293b; font-weight: 800; font-size: 0.95rem; text-decoration: none; margin-bottom: 18px;">
                ...
                <div style="display: flex; align-items: center; gap: 12px; margin: 0 0 18px; color: #94a3b8; font-size: 0.72rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.6px;">
                    <span style="flex: 1; height: 1px; background: #e2e8f0;"></span>o con tu email<span style="flex: 1; height: 1px; background: #e2e8f0;"></span>
                </div>
                <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 8px 18px; margin-bottom: 28px; color: #1e3a8a; font-size: 0.85rem; font-weight: 600;">
                    <span style="display: inline-flex; align-items: center; gap: 6px;">
                        ...
                        <?= (int) solvencia('consultasGratis', 3) ?> consultas gratis al mes
                    </span>
                    <span style="display: inline-flex; align-items: center; gap: 6px;">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#2563eb" stroke-width="3"><polyline points="20 6 9 17 4 12"></polyline></svg>
