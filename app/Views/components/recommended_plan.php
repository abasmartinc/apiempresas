...
if (!in_array($userPlanId, [1, 2, 3, 6])) {
    return; // No mostramos CTA de planes para usuarios con planes personalizados.
}
...
<section class="dash-card plan-card--recommended"
    style="border: 1px solid #e2e8f0; position: relative; background: #ffffff; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.05), 0 10px 10px -5px rgba(0, 0, 0, 0.02); overflow: hidden; border-radius: 16px;">
    <div
        style="position: absolute; top: -1px; left: 0; right: 0; height: 4px; background: linear-gradient(90deg, #2152ff, #12b48a);">
    </div>
    ...
    <div style="padding: 24px;">
        ...
        <div
            style="background: #f8fafc; border-radius: 12px; padding: 16px; margin-bottom: 24px; border: 1px solid #f1f5f9;">
            <ul style="list-style: none; padding: 0; margin: 0; display: grid; gap: 12px;">
                <li
                    style="display: flex; align-items: center; gap: 10px; font-size: 0.9rem; font-weight: 700; color: #334155;">
        ...
        <div
            style="margin-top: 20px; text-align: center; font-size: 0.75rem; color: #94a3b8; font-weight: 700; display: flex; flex-direction: column; gap: 6px;">
