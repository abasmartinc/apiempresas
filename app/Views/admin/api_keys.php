                ...
                <tr style="border-bottom: 1px solid #f1f5f9;">
                    ...
                    <td style="padding: 12px;">
                        <div style="display: flex; gap: 5px;">
                            ...
                            <a href="<?= site_url('admin/api-keys/delete/' . $k->id) ?>" class="btn ghost" style="padding: 4px 8px; font-size: 0.75rem; color: #ef4444; border-color: #fee2e2;" title="Eliminar" data-confirm="¿Estás seguro de eliminar esta API Key?">🗑️</a>
                        </div>
                    </td>
                </tr>
                <?php endforeach; ?>
