...
<head>
    ...
    <style>
        ...
        .metric-card { background: var(--card-bg); border-radius: 20px; padding: 1.5rem; border: 1px solid var(--border-color); box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05); height: 100%; }
        ...
        .table-custom { color: var(--text-main); font-size: 0.9rem; }
        .table-custom thead th { border: none; color: var(--text-muted); font-weight: 600; text-transform: uppercase; font-size: 0.7rem; }
        ...
        .page-link { border: none; color: var(--text-muted); border-radius: 8px !important; margin: 0 2px; }
...
<div class="container">
    ...
    <div id="ai-container" class="ai-card" style="display: none;">
        ...
        <div id="ai-loader" style="display:none;" class="text-center py-3"><div class="spinner-border text-primary" role="status"></div></div>
    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-md-3"><div class="metric-card"><div class="metric-label">Filtros Activos</div><div class="metric-value" style="font-size: 1.5rem;"><?= count(array_filter($filters)) ?></div></div></div>
    </div>
            ...
            .then(html => {
                ...
                container.querySelectorAll('.pagination a').forEach(link => {
                    link.addEventListener('click', function(e) {
                        ...
                        const pageNum = url.searchParams.get('page_events');
                        loadTable(pageNum);
                    });
                });
            });
