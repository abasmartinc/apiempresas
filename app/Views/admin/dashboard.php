        ...
        <div class="dashboard-groups" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(450px, 1fr)); gap: 32px;">
            ...
            <div class="group-card" style="background: #fff; border-radius: 28px; border: 1px solid #f1f5f9; overflow: hidden; box-shadow: 0 4px 20px -2px rgba(0,0,0,0.05);">
                ...
                <div style="padding: 8px 0;">
                    ...
                    <a href="<?= site_url('admin/api-analytics') ?>" class="group-link">
                        <span class="link-icon icon-sub-blue"><svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3-4.5 16.5" /></svg></span>
                        <div class="link-text">
                            <strong style="display: flex; align-items: center; gap: 6px;">
                                API & Desarrolladores
                                <span style="background: #2563eb; color: white; font-size: 0.65rem; padding: 1px 6px; border-radius: 99px; font-weight: 800;">CORE</span>
                            </strong>
                            <p>Consumo de peticiones, embudo de activación y planes de pago.</p>
                        </div>
                    </a>
