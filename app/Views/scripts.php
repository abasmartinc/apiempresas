                ...
                html: `
                    <div style="padding: 20px 10px; text-align: center; position: relative;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; margin-top: 10px;">
                            <a href="<?= site_url('auth/google') ?>" style="display: flex; align-items: center; justify-content: center; gap: 6px; background: white; color: #1e293b; border: 1px solid #e2e8f0; border-radius: 12px; padding: 12px 5px; font-weight: 800; text-decoration: none; font-size: 0.8rem; transition: all 0.2s;">
                                <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" width="16">
                                Google
                            </a>
                            <a href="<?= site_url('auth/github') ?>" style="display: flex; align-items: center; justify-content: center; gap: 6px; background: #24292e; color: white; border: 1px solid #24292e; border-radius: 12px; padding: 12px 5px; font-weight: 800; text-decoration: none; font-size: 0.8rem; transition: all 0.2s;">
                            ...
                            <a href="<?= site_url('auth/linkedin') ?>" style="display: flex; align-items: center; justify-content: center; gap: 6px; background: #0077b5; color: white; border: 1px solid #0077b5; border-radius: 12px; padding: 12px 5px; font-weight: 800; text-decoration: none; font-size: 0.8rem; transition: all 0.2s;">
