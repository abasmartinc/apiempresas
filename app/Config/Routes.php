...
// LinkedIn Auth
$routes->get('auth/linkedin', 'LinkedinAuth::login');
...
$routes->get('empresa/preview-risk/(:num)', 'Company::previewRiskPdf/$1');
$routes->get('ejemplo/dictamen-riesgo', 'Company::sampleRiskPdf');
$routes->get('ejemplo/informe-riesgo', 'Company::sampleRiskPdf');
$routes->get('ejemplo/dossier-360', 'Company::sampleDossierPdf');
$routes->get('ejemplo/dossier-completo', 'Company::sampleDossierPdf');
