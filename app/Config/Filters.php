...
class Filters extends BaseFilters
{
    ...
    public array $globals = [
        'before' => [
             ...
             'user_activity',
             'csrf' => ['except' => ['api/*', 'tracking/*', 'webhook/*', 'events/*', 'company/rate', 'company/rate_feedback', 'company/data-feedback', 'admin/risk-profile/email-*']],
            // 'invalidchars',
        ],
        'after' => [
            'activity_logger',
