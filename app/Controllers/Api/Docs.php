...
#[OA\Info(title: "API Empresas", version: "1.0.0", description: "Documentación oficial de la API de Empresas. Soporte nativo para el estándar de errores RFC 7807 (Problem Details), Protección Rate Limiting, y Paginación por Cursores.")]
